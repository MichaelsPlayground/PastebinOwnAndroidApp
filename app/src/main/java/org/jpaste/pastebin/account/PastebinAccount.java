			...
			try {
				...
				for (int i = 0; i < nodes.getLength(); i++) {
					...
					if (node.getNodeType() == Node.ELEMENT_NODE) {
						...
						/*
						System.out.println("*#* expireDate: " + String.valueOf(expireDate) + " pasteDate: " + String.valueOf(pasteDate) + " *#*");
						System.out.println("*#* expireDate: " + (int) (expireDate - pasteDate) +
								" PasteExpireDate: " + PasteExpireDate.getExpireDate((int) (expireDate - pasteDate)));
						System.out.println("*#* expireDate: " + (int) (expireDate - pasteDate) +
								" PasteExpireDate: " + PasteExpireDate.getExpireDate((int) (expireDate - pasteDate)).getValue());
						 */
